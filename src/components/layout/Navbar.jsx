...
const Navbar = () => {
    ...
    const activeLinkClass = ({ isActive }) =>
        `flex items-center gap-1.5 text-sm font-medium transition-colors ${isActive ? 'text-orange-400' : 'text-gray-300 hover:text-white'
        }`;
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    {user?.role === 'admin' && (
                        <Link
                            ...
                            className="flex items-center gap-2 px-4 py-2.5 text-sm text-purple-400 hover:bg-gray-700 transition-colors"
                        >
